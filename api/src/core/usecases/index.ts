...
import type { FetchAndSaveExternalData, FetchAndSaveExternalDataForSoftware } from "./refreshExternalData";
...
export type UseCases = {
    ...
    fetchAndSaveExternalDataForAllSoftware: FetchAndSaveExternalData;
